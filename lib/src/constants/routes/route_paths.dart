    ...
    switch (routeSettings.name) {
      ...
      case RoutesPaths.productDetails:
        ...
        return MaterialPageRoute(
          builder: (_) => ProductDetailsScreen(productModel: productModel),
        );
      ...
      case AddressScreen.route:
        ...
        return MaterialPageRoute(
          builder: (_) => AddressScreen(hasButton: hasButton),
        );
      ...
      case OrderDetails.route:
        ...
        return MaterialPageRoute(
          builder: (_) => OrderDetails(userOrdersModel: userOrdersModel),
        );
      case EditUserAddress.route:
        final String addressDocId = routeSettings.arguments as String;

        return MaterialPageRoute(
          builder: (_) => EditUserAddress(selectedAddressId: addressDocId),
        );
      case RoutesPaths.wishlistWidget:
        final bool hasBackArrow = routeSettings.arguments as bool;
        return MaterialPageRoute(
          builder: (_) => WishlistWidget(hasBackArrow: hasBackArrow),
        );
      case RoutesPaths.wishlistViewScreen:
        final bool hasBackArrow = routeSettings.arguments as bool;
        return MaterialPageRoute(
          builder: (_) => WishlistViewScreen(hasBackArrow: hasBackArrow),
        );
